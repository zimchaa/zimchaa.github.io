...
const App = () => {
  ...
  const gravatarLink = get_gravatar("jaison.miller@vodafone.com");
  ...
  return (
    <Grommet theme={grommet}>
      ...
      >
        <Header background="light-4" pad="small" gridArea="header">
          <Button onClick={() => setSidebar(!sidebar)}>
            <Text size="large">Projects</Text>
          </Button>
          <Text>jaison.miller@gmail.com</Text>
          <Nav direction="row">
